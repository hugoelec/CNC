...
static void lcd_prepare_menu()
{
    ...
    //MENU_ITEM(gcode, MSG_AUTO_HOME, PSTR("G92 X0 Y0 Z0"/*"G28"*/));
    MENU_ITEM(function, MSG_AUTO_HOME, new_home);//************************
    MENU_ITEM(function, "Z-Origin", Z_home);//************************
    MENU_ITEM(gcode, MSG_SET_ORIGIN, PSTR("G92 X0 Y0 Z0"));//************************
    MENU_ITEM(gcode, "Go to ORIGIN", PSTR("G1 X0 Y0 Z0 F240.000"));//************************
